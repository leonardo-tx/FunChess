...
public sealed class AccountTest
{
    ...
    private readonly AccountForm[] _validAccountForms =
    {
        ...
        new() { Email = "test2@domain.net", Password = "P@ssw0", Username = "LongUsernameThatIsMoreThan64CharactersIsNotValid" },
        ...
        new() { Email = "user12@ex-ample.com", Password = "ValidPassword", Username = "ValidUsernameWithDashes-123" },
        new() { Email = "user13@example.org", Password = "1@2#3$4%", Username = "Valid_Username" },
        new() { Email = "name14@sub.domain.com", Password = "123456", Username = "ValidUsernameWithUnderscore_123" },
        ...
        new() { Email = "email17@example-domain.net", Password = "ValidPassword123456789012345678901234567890", Username = "UsernameWithDashes-12345" },
        new() { Email = "user18@example.co", Password = "Valid12345", Username = "ValidUsername12345678901234567890123456789012345" },
        new() { Email = "test19@sub.domain.co.uk", Password = "1A2B3C4D5E6F7G8H9I0J1K2L3M4N5O6P7Q8R9S0T1U2V3W4X5Y6Z", Username = "ValidUsername123456789012345678901234567890123456789012345678901" },
        new() { Email = "user20@example.io", Password = "ValidP@ssw0rdWithSpecialChars123456789012345678901234567890123456789012345678901234567890123454234f23rf23rertgerrgtg3t4t34tg45t5", Username = "ValidUsername12345678901234567890123456789012345" }
    };
}